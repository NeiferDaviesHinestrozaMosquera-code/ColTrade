...
import 'export_assistant_screen.dart';
import 'import_assistant_screen.dart';
import 'calculator_screen.dart';
import 'knowledge_center_screen.dart';
import 'nandina_classifier_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
            ...
            Row(
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.inter(
                    fontSize: 12,
                    fontWeight: statusColor == AppColors.errorRed ? FontWeight.w700 : FontWeight.normal,
                    color: statusColor,
                  ),
                ),
                Text(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const Icon(Icons.calculate_rounded, color: Colors.white30, size: 60),
                ],
              ),
            ),
          ),
          ...
          GridView.count(
            ...
            children: [
              _toolCard(Icons.folder_outlined, 'Repositorio', 'Gestiona documentos'),
              _toolCard(Icons.history_rounded, 'Historial', 'Últimas consultas'),
              _toolCard(Icons.notifications_outlined, 'Alertas', 'Regulaciones DIAN',
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const AlertsScreen()),
                  )),
  ...
  Widget _toolCard(IconData icon, String title, String subtitle, {VoidCallback? onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
      ...
      body: ListView(
        ...
        children: [
          ...
          _profileSection('CONFIGURACIÓN', [
            _profileItem(Icons.person_outline, 'Información Personal', 'Datos de tu perfil',
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const PersonalInfoScreen()),
                )),
            _profileItem(Icons.business_outlined, 'Empresa', 'TechCorp Solutions',
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const CompanyInfoScreen()),
                )),
            _profileItem(Icons.security_outlined, 'Seguridad', 'Contraseña y 2FA',
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const SecurityScreen()),
                )),
            _profileItem(Icons.notifications_outlined, 'Notificaciones', 'Alertas y frecuencia',
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const NotificationsScreen()),
                )),
            _profileItem(Icons.api_outlined, 'API / ERP', 'Sincronización SAP', badge: 'ENT'),
          ]),
          const SizedBox(height: 16),
          _profileSection('CENTRO DE AYUDA', [
            _profileItem(Icons.confirmation_number_outlined, 'Mis Tickets', 'Soporte activo',
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const MyTicketsScreen()),
                )),
            _profileItem(Icons.play_circle_outline, 'Tutoriales', 'Videos de ayuda',
                onTap: () => Navigator.push(
                  context,
  ...
  Widget _profileItem(IconData icon, String title, String subtitle, {String? badge, VoidCallback? onTap}) {
    return ListTile(
      onTap: onTap,
        ...
        children: [
          ...
          if (badge != null) ...[
            ...
            Container(
              ...
              child: Text(badge,
                  style: AppTextStyles.badgeText.copyWith(fontSize: 9, color: Colors.white)),
            ),
          ],
        ],
      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Icon(
                        ...
                        color: active ? AppColors.accentOrange : AppColors.textLabel,
                        size: 22,
                      ),
                      const SizedBox(height: 2),
                      Text(
