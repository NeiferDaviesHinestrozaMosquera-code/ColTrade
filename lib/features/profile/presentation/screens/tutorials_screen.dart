...
class _TutorialsScreenState extends State<TutorialsScreen> {
  ...
  List<_Tutorial> get _filtered => _selected == 'Todos'
      ? _all
      : _all.where((t) => t.category == _selected).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const ColTradeAppBar(title: 'Tutoriales', dark: true),
      body: ListView(
                ...
                children: [
                  Center(
                    child: Icon(tutorial.thumbIcon,
                        size: 44,
                        color: tutorial.thumbColor.withValues(alpha: 0.4)),
                  ),
                  Center(
                    child: Container(
                      width: 38,
