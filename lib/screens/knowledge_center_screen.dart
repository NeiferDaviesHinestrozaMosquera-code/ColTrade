  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Centro de Conocimiento',
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: ['INICIO', 'CURSOS', 'WEBINARS', 'PERFIL'].asMap().entries.map((e) {
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.inter(
                          ...
                          color: active ? AppColors.accentOrange : const Color(0xFF94A3B8),
                        ),
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Módulo 4 de ${course.totalModules}: Optimización de rutas',
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.school_rounded, color: Colors.white38, size: 32),
          ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Text('EN VIVO',
                          style: AppTextStyles.badgeText
                              .copyWith(fontSize: 10, color: AppColors.errorRed)),
                      const Spacer(),
                      Container(
                  ...
                  const SizedBox(height: 12),
                  Text('Nuevas oportunidades de exportación en TLC Colombia-Indonesia',
                      style: GoogleFonts.inter(
                          fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      const Icon(Icons.people_rounded, size: 14, color: Colors.white60),
...
class _Course {
  ...
  _Course(this.title, this.totalModules, this.completedModules, this.rating, this.duration, this.progress);
}
