...
class _ImportAssistantScreenState extends State<ImportAssistantScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Asistente de Importación',
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
        // AI Chat bubble
        Text('COLTRADE AI',
            style: AppTextStyles.labelUppercase.copyWith(color: AppColors.textLabel)),
              ...
              child: Container(
                ...
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      const TextSpan(text: 'Hola, soy tu asistente de importación. Para comenzar necesito:\n\n'),
                      const TextSpan(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('Generando pre-liquidación...', style: AppTextStyles.bodySmall),
              ],
            ),
          ),
        ),
        ...
        TextFormField(
          ...
          decoration: AppDecorations.inputDecoration(
            ...
            suffix: const Icon(Icons.account_tree_outlined, size: 18, color: AppColors.textLabel),
          ),
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: AppDecorations.inputDecoration('', '',
                        prefix: const Icon(Icons.public_rounded, size: 18, color: AppColors.textLabel)),
                    items: ['China', 'Estados Unidos', 'Alemania', 'India', 'Brasil', 'México']
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: AppDecorations.inputDecoration(
                      '',
                      '0.00',
                      prefix: const Icon(Icons.scale_outlined, size: 18, color: AppColors.textLabel),
                    ),
                  ),
                ],
              ),
        ...
        TextFormField(
          ...
          decoration: AppDecorations.inputDecoration(
            '',
            '0.00',
            prefix: const Icon(Icons.attach_money_rounded, size: 18, color: AppColors.textLabel),
          ),
        ),
      ],
    );
  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text('La IA ha sugerido la siguiente clasificación arancelaria para tu producto.',
          ...
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    child: Text('98% COINCIDENCIA',
                        style: AppTextStyles.badgeText
                            .copyWith(color: const Color(0xFF92400E), fontSize: 10)),
                  ),
                ],
              ),
              const SizedBox(height: 8),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border(left: BorderSide(color: AppColors.yellowAmber, width: 2)),
      ...
      children: [
        Text('Puerto de entrada',
            style: GoogleFonts.inter(
                fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
        const SizedBox(height: 8),
        Text('Selecciona el puerto por donde ingresará tu mercancía.', style: AppTextStyles.bodySmall),
        const SizedBox(height: 20),
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                child: Icon(Icons.anchor_rounded,
                    color: selected ? AppColors.primaryDarkNavy : AppColors.textLabel),
              ),
              ...
              trailing: selected
                  ? Container(
                      ...
                      decoration: const BoxDecoration(
                          color: AppColors.primaryDarkNavy, shape: BoxShape.circle),
      ...
      children: [
        Text('Resumen de importación',
            style: GoogleFonts.inter(
                fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
        const SizedBox(height: 8),
        Text('Tu expediente ha sido generado con éxito.', style: AppTextStyles.bodySmall),
        const SizedBox(height: 20),
          ...
          child: Column(
            ...
            children: [
              Text('RESUMEN DE COSTOS',
                  style: AppTextStyles.labelUppercase.copyWith(color: Colors.white60)),
              const SizedBox(height: 16),
              ...
              Row(
                ...
                children: [
                  ...
                  Text('\$8,009.75',
                      style: GoogleFonts.inter(
                          fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.accentOrange)),
                ],
              ),
            ],
          ),
  ...
  Widget _formLabel(String label) => Text(label, style: AppTextStyles.labelUppercase);
  ...
  Widget _buildFooter() {
    return Container(
      ...
      child: Column(
        children: [
          CTAButton(
            label: _currentStep < 4 ? 'Continuar con el Expediente >' : '✅  Finalizar Importación',
            onTap: () {
