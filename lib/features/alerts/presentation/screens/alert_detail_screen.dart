            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      Expanded(
                          child: _metaCell('PUBLICACIÓN', alert.date,
                              Icons.calendar_today_outlined)),
                      const SizedBox(width: 12),
                      Expanded(
                          child: _metaCell('VIGENCIA', '01 Nov 2024',
                    ...
                    Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            _impactRow(true,
                                'Actualice sus formularios DIAN antes del 31 de octubre'),
                            const SizedBox(height: 6),
                            _impactRow(false,
                                'Verifique clasificación arancelaria de sus productos'),
                            const SizedBox(height: 6),
                            _impactRow(true,
                                'Coordine con su agente de aduana los cambios operativos'),
                          ]),
                    ),
                    const SizedBox(height: 20),
                    Text('Recursos',
                    ...
                    OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(
                            color: AppColors.primaryDarkNavy, width: 1.5),
                      ...
                      label: Text('Seguir esta alerta',
                          style: AppTextStyles.buttonCTA
                              .copyWith(color: AppColors.primaryDarkNavy)),
                    ),
                    const SizedBox(height: 10),
                    CTAButton(
                        label: '🤖  Consultar a la IA sobre esta alerta',
                        onTap: () {}),
                    const SizedBox(height: 10),
                    Center(
