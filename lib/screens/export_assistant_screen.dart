...
class _ExportAssistantScreenState extends State<ExportAssistantScreen> {
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: AppDecorations.inputDecoration(
            ...
            suffix: const Icon(Icons.search_rounded, color: AppColors.textLabel),
          ),
        ),
        const SizedBox(height: 24),
              ...
              Row(
                children: [
                  ...
                  Text('Clasificación por IA',
                      style: GoogleFonts.inter(
                          fontSize: 17, fontWeight: FontWeight.w600, color: Colors.purple.shade900)),
                ],
              ),
              const SizedBox(height: 4),
              Text('Sube una foto y la IA identificará tu producto automáticamente',
                  style: AppTextStyles.bodySmall),
  ...
  Widget _buildStep2() {
    const destinos = ['España', 'Estados Unidos', 'Alemania', 'Japón', 'Brasil', 'México'];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          hint: Text('Seleccionar país destino', style: AppTextStyles.bodySmall),
          decoration: AppDecorations.inputDecoration('', '',
              prefix: const Icon(Icons.public_rounded, color: AppColors.textLabel)),
          items: destinos
      ...
      children: [
        Text('Documentos requeridos',
            style: GoogleFonts.inter(
                fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
        const SizedBox(height: 8),
        Text('ColTrade ha identificado los documentos necesarios para tu operación.',
            style: AppTextStyles.bodySmall),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border:
                completed ? null : Border.all(color: AppColors.border, width: 1.5),
        ...
        if (uploading)
          ...
          const Icon(Icons.visibility_outlined, size: 18, color: AppColors.textLabel),
        if (completed)
          const Icon(Icons.visibility_outlined, size: 18, color: AppColors.textLabel),
      ],
    );
      ...
      children: [
        Text('Resumen de exportación',
            style: GoogleFonts.inter(
                fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
        const SizedBox(height: 8),
        Text('Revisa los datos antes de generar tu expediente.', style: AppTextStyles.bodySmall),
        const SizedBox(height: 20),
        ...
        Container(
          ...
          child: Column(
            children: [
              _summaryRow('Producto', _productController.text.isEmpty ? 'Café Premium' : _productController.text),
              const Divider(height: 16),
              _summaryRow('Destino', _selectedDestino ?? 'España'),
              const Divider(height: 16),
              _summaryRow('Transporte', _selectedTransport == 'aereo' ? '✈️ Aéreo' : '🚢 Marítimo'),
              const Divider(height: 16),
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: AppTextStyles.bodySmall.copyWith(color: AppColors.successGreen.withValues(alpha: 0.8)),
                ),
              ),
            ],
          ),
  ...
  Widget _summaryRow(String label, String value) {
    return Row(
      ...
      children: [
        ...
        Text(value,
            style: AppTextStyles.bodyRegular.copyWith(fontWeight: FontWeight.w600, fontSize: 14)),
      ],
    );
  }
