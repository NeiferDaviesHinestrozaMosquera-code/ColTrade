...
class _LessonPlayerScreenState extends State<LessonPlayerScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Lesson list
                  ..._lessons.asMap().entries.map((e) => _buildLessonItem(e.key + 1, e.value)).toList(),
              ...
              children: [
                ...
                ClipRRect(
                  child: LinearProgressIndicator(
                    ...
                    valueColor: const AlwaysStoppedAnimation<Color>(AppColors.colombiaYellow),
                    minHeight: 3,
                  ),
                ),
              ],
  ...
  Widget _buildLessonItem(int num, (bool completed, String label, String title) data) {
                ...
                children: [
                  Text('VIENDO AHORA',
                      style: AppTextStyles.labelUppercase
                          .copyWith(color: AppColors.accentOrange, fontSize: 9)),
                  Text(title,
                      style: GoogleFonts.inter(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: completed ? null : Border.all(color: AppColors.border, width: 1.5),
              shape: BoxShape.circle,
            ),
            child: completed
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(label.toUpperCase(), style: AppTextStyles.labelUppercase.copyWith(fontSize: 9)),
                Text(title,
          ...
          const Icon(Icons.more_vert_rounded, color: AppColors.textLabel, size: 16),
        ],
      ),
    );
  }
